# Vice: instant-replay game clipper. Upstream ships no Nix packaging, so this
# is the expression from the PR (github.com/eklonofficial/Vice nix/package.nix),
# vendored here with a pinned src until it lands upstream.
{
  lib,
  fetchFromGitHub,
  python3Packages,
...
python3Packages.buildPythonApplication rec {
  ...
  src = fetchFromGitHub {
    owner = "eklonofficial";
    repo = "Vice";
    rev = "aea5a5b8f460c8a4a36d3cdbf2afbd4fe3ce2297";
  ...
  # The suite wants a real compositor, evdev nodes and GPU capture.
  doCheck = false;
