                        ...
                        sourceComponent: Item {
                            ...
                            Component {
                                ...
                                Row {
                                    ...
                                    Item {
                                        // Capsule "number-reveal": show the workspace number ONLY on the
                                        // active (or hovered) workspace, so inactive ones stay as dots.
                                        // (ported from the user's waybar switcher)
                                        visible: ((SettingsData.showWorkspaceIndex || SettingsData.showWorkspaceName) && !loadedHasIcon && (isActive || isHovered)) || (loadedHasIcon && SettingsData.showWorkspaceName && hasWorkspaceName)
